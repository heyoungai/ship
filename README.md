...
- 快速上手：[docs/guides/quick-start.md](docs/guides/quick-start.md)
...
完整设计与边界见 [docs/engineering/git-tag-release-strategy.md](docs/engineering/git-tag-release-strategy.md)。v2.7.1 digest pin 修复复盘见 [docs/changes/completed/hotfix-v2.7.1-digest-pin.md](docs/changes/completed/hotfix-v2.7.1-digest-pin.md)。
