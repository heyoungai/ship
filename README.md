...
- [docs/git-tag-release-strategy.md](docs/git-tag-release-strategy.md) — Git tag、源码快照与不可变产物一致的真实版本构建策略
- [docs/ship-v3.md](docs/ship-v3.md) — 以 Plan、Artifact、Environment 和 Run 为核心的 v3 设计
